...
Mads Hovgaard har udviklet et [aktivitetshjul](https://www.legestue.net/aktivitetshjulet/), som tilføjer et par ekstra dimensioner til spilhjulet.
...
{% include figure image_path="https://www.legestue.net/assets/images/posts/aktivitetshjulet.png" caption="Aktivitetshjulet til at analysere aktiviteter, men som også kan bruges som udgangspunkt for øvelselsudvikling." alt="aktivitetshjulet til øvelsesudvikling" %}
...
{% include figure image_path="https://skoleidraet.dk/media/6345374/boldspilsdugen.jpg?width=500&height=466" caption="Boldspilsdugen ser sådan her ud. Den kan købes fra [Dansk Skoleidræt](https://skoleidraet.dk/webshop/produkter/boldspilsdug-skolernes-motionsdag-2016){: rel='nofollow noopener' }" alt="boldspilsdugen til aktivitetsudvikling" %}
...
{% include video provider="youtube" id="f7ohL7SNcJA" %}
